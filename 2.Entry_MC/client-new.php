		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR
							USUARIO</a>
					</li>
					<li>
							...
							<div class="row">
								<div class="col-10 col-md-7">
									<div class="form-group">
										...
										<input class="form-control form-control-sm" type="text" name="Id_Usuario"
											id="Id_Usuario" placeholder="El Codigo es Asignado por el Sistema" autofocus
											required aria-label=".form-control-sm example" readOnly maxlength="27">
									</div>
								</div>
								<div class="col-10 col-md-7">
									<div class="form-group">
										<label for="Usuario_Nombre" class="bmd-label-floating">Nombre</label>
										<input type="text" required class="form-control" name="Usuario_Nombre"
											id="Usuario_Nombre" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										<label for="Usuario_Apellido" class="bmd-label-floating">Apellido</label>
										<input type="text" required class="form-control" name="Usuario_Apellido"
											id="Usuario_Apellido" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
								...
								<div class="col-12 col-md-7">
									<div class="form-group">
										<label for="Usuario_NumeroDocumento" class="bmd-label-floating">Numero de
											documento</label>
										<input type="text" required class="form-control" name="Usuario_NumeroDocumento"
											id="Usuario_NumeroDocumento" maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
								...
								<div class="col-10 col-md-7">
									<div class="form-group">
										<label for="Usuario_Correo" class="bmd-label-floating">Correo
											electronico</label>
										<input type="text" required class="form-control" name="Usuario_Correo"
											id="Usuario_Correo" maxlength="150">
									</div>
								</div>
								<div class="col-10 col-md-7">
									<div class="form-group">
								...
								<div class="col-10 col-md-7">
									<div class="form-group">
										...
										<input type="text" required class="form-control" name="Usuario_Login"
											id="Usuario_Login">
									</div>
								</div>
								<div class="col-10 col-md-7">
									<div class="form-group">
										...
										<input type="password" required class="form-control" name="Usuario_Password"
											id="Usuario_Password">
									</div>
								</div>
							</div>

        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="client-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                            LISTA DE USUARIOS</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="container-fluid">
                ...
                if (isset($_GET['buscar'])) {
                    ...
                    $query = "SELECT Id_Usuario, Nombre_Usuario, Apellido_Usuario, R.Nombre_Rol, Nombre_Documento, Numero_Documento, Direccion, Correo_Electronico, Celular, EU.Nombre_Estado, Login, Password FROM usuarios U 
                    INNER JOIN tipo_documentos TP ON U.Tipo_Documento = TP.Id_Tipo_Documento 
                    INNER JOIN estados_usuarios EU ON U.Estado_Usuario = EU.ID_ESTADO_USUARIO
                            ...
                            <table class="table table-dark table-sm">
                                ...
                                <?php foreach ($datos as $fila) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $fila['Apellido_Usuario']; ?>
                                        </td>
                                        <td>

		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Registro-Salida-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR REGISTRO DE
							SALIDA</a>
					</li>
					<li>
			...
			<div class="container-fluid">
				...
				<form method="GET" action="BusquedaVehiculoSalida.php">
							...
							do {
								...
								<tbody>
									<tr class="text-center">
										<td>
											<?php echo $RegistroSalida[0] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[1] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[2] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[3] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[4] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[5] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[6] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[7] ?>
										</td>
										<td>
											<?php echo $RegistroSalida[8] ?>
										</td>
										<td>
											<a href=" <?php if ($RegistroSalida[0] <> '') {
												echo "Registro-Salida-Update.php?key=" . urlencode($RegistroSalida[0]);

		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<form action="" class="form-neon" autocomplete="off" method="POST">
					<fieldset>
						<legend><i class="fas fa-bus"></i> &nbsp; Información básica de Vehículo</legend>
						<div class="container-fluid">
							<div class="row">
								<div class="col-10 col-md-7">
									<div class="form-group">
										...
										<input class="form-control form-control-sm" type="text" name="Id_Vehiculo"
											id="Id_Vehiculo" placeholder="El Codigo es Asignado por el Sistema"
								...
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="Vehiculo_Codigo"
											id="Vehiculo_Codigo" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="Vehiculo_Placa"
											id="Vehiculo_Placa" maxlength="10">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										<label for="Vehiculo_Marca" class="bmd-label-floating">Marca</label>
										<input type="text" class="form-control" name="Vehiculo_Marca"
											id="Vehiculo_Marca" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="Vehiculo_Modelo"
											id="Vehiculo_Modelo" maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ#- ]{1,150}"
											class="form-control" name="Vehiculo_Color" id="Vehiculo_Color"
											maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-7">

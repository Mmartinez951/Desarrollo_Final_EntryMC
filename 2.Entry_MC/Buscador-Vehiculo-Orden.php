        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="" href="Vehiculo-List.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp;
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" value=<?php echo $fila['Estado_Vehiculo'] ?>
                                            name="Nombre_Estado" id="Nombre_Estado">
                                            <?php
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="Fecha_Orden_Trabajo" name="Fecha_Orden_Trabajo"

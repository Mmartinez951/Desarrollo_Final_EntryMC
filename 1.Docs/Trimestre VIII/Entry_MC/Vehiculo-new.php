							...
							<div class="row">
								...
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="Vehiculo_Codigo" id="Vehiculo_Codigo" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
										<label for="Vehiculo_Placa" class="bmd-label-floating">Placa</label>
										<input type="text"  class="form-control" name="Vehiculo_Placa" id="Vehiculo_Placa" maxlength="10">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">
								...
								<div class="col-12 col-md-7">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="Vehiculo_Modelo" id="Vehiculo_Modelo" maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-7">
									<div class="form-group">

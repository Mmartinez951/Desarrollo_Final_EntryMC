		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="Registr-Salida-New.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR REGISTRO DE SALIDA</a>
					</li>
					<li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<div style="text-align: right;width: 95%;px">
				<form method="GET">
  				<input type="text" name="termino_busqueda" placeholder="Buscar Vehiculo">
					...
					<fieldset>
						...
						<div class="container-fluid">
							...
							<div class="row">
	                            ...
	                            <input type="text" required class="form-control" name="Id_Vehiculo" id="Id_Vehiculo" maxlength="40">

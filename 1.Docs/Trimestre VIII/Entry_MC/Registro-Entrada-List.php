		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Registro-salida-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR REGISTRO DE ENTRADA</a>
					</li>
					<li>
						<a class="active" href="Vehiculo-List.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE REGISTRO DE ENTRADAS</a>
					</li>
				</ul>	
			</div>

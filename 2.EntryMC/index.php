...
if(isset($_POST['Ingresar']))
{
  ...
  $nombreUsuario=$_POST['UserPassword'];
  $claveUsuario=$_POST['UserName'];
  $_SESSION['UserPassword'] = $nombreUsuario;
	...
	<div class="login-container" method="POST">
		<div class="login-content">
			...
			<p class="text-center">
				...
				<button type="submit" class="btn-login text-center" name="Ingresar"> INICIAR SESIÓN </button> 
		</div>
	</div>
